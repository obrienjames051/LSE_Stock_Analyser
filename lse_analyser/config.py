...
SECTOR_QUERIES = {
    ...
    "Mining":       "Rio Tinto OR Glencore OR Anglo American OR BHP",
    "Chemicals":    "UK chemicals sector",
    "Materials":    "UK construction materials sector",
    "Industrials":  "aerospace defence manufacturing UK industry",
    "Tech":         "UK technology sector",
    "ConsStaples":  "Unilever OR Diageo OR Reckitt OR Associated British Foods",
